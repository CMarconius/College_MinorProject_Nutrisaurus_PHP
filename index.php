...
<html>
	<head>
		...
		<meta name="description" content="College Project Nutrition Thesaurus Nutrisaurus home">
		<meta name="author" content="Mark Thomas sTeam12">
		<meta name="google-site-verification" content="AVyaP2bHbwfXKd1PBdUSCTOmiarJB3x0_VMSPjMoYiY" />

		<title>Nutrisaurus Home</title>
	...
	<!--Navbar containing buttons to give the user access to the Home Page, the About Page, and the contact form-->
		<nav id="mainNav" class="navbar navbar-default navbar-static-top">
			<div class="container nav-background-green">
				...
				<div class="navbar-header">
					...
					<a type="button" class="btn btn-success btn-lg home-button active" href="index.php"><img src="img/NS-logo-small.png"></img></a>
				</div>
			...
			<!-- Collapsable buttons which are replaced by the tripple bar icon -->	
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a class="btn btn-success btn-lg nav-button-right active" href="index.php"><p class="nav-button-right">Home</p></a>
						</li>
						<li>
							<a class="btn btn-success btn-lg nav-button-right" href="about.php"><p class="nav-button-right">About</p></a>
						</li>
						<li>
			...
			<div class="container">
				<div class="row home-header">
					<div class="container text-center">
						...
						<img class="image-dark-glow" src="img/nutrisaurus-logo.png">
						<h3 class="header-Large-Text text-dark-glow">TAKE CONTROL OF YOUR DIET</h3>
						<h5 class="text-dark-glow">Healthy eating is too expensive: MYTH! Take the hassle out of eating healthy.</h5>
						<h5 class="text-dark-glow">NutriSaurus will help you find recipes that are great for your body and great for you pocket!</h5>
						<a id="app-store-button" type="button" class="btn btn-success btn-lg"  onclick="window.open('https://itunes.apple.com/ie/genre/ios/id36?mt=8')"></a>
						</br></br></br></br>
					</div>
				</div>    
			
				<div class="row text-center light-background">
							<br></br>
					<div class="col-md-4">
						<img src="img/barcode.png">
						<h4>Scan and Save</h4>
						<p>Scan barcodes to find a cheap alternative. Better yet, you can find a healthier option of the same product.</p>
					</div>
					<div class="col-md-4">
						<img src="img/chef.png">
						<h4>Your Own Chef</h4>
						<p>Have your very own chef to guide you. Make things easier with a tailored menu for all the family.</p>
					</div>
					<div class="col-md-4">
						<img src="img/shopping-list.png">
						<h4>Tailored Shopping List</h4>
						<p>Find your recipes and add the ingredients automatically to your shopping list.Quick, easy and with no fuss.</p>
							</br></br>
					</div>
				</div>
		...
		<!-- A nice transition from the light bacground to the green background -->
				<div class="row" >
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								<div class="container" id="contactForm">
									...
									<!-- Form for submitting the Contact details, which include the users Name, Email and a message of the user's making -->
									<!-- Form sends the data via POST, to be collected at the top of this file where the Database object adds contact information to the database -->
